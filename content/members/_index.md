...
<div style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 40px;">
  ...
  <div style="flex-shrink: 0;">
    <img src="/images/InjaeHong.jpg" alt="Injae Hong" style="width: 200px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  </div>

  <div>
    <h1 style="margin-top: 0; margin-bottom: 10px; font-size: 1.4rem"><strong>Injae Hong / Principal Investigator</strong></h1>
